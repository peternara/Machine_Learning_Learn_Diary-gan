...
class VariationalAutoencoder(object):
    ...
    def _recognition_network(self):
        with tf.variable_scope('recognition_network_layer_1'):
            ...
            rec_layer_1 = self.transfer_fct(tf.matmul(self.x, rec_weights_h1) + rec_biases_h1,
                                            name='recognition_network_layer_1')
        ...
        with tf.variable_scope('recognition_network_layer_2'):
            ...
            rec_layer_2 = self.transfer_fct(tf.matmul(rec_layer_1, rec_weights_h2) + rec_biases_h2,
                                            name='recognition_network_layer_2')
        ...
        with tf.variable_scope('recognition_network_sigma'):
            ...
            z_log_sigma_sq = tf.add(tf.matmul(rec_layer_2, weights_out_log_sigma), biases_out_log_sigma,
                                    name='recognition_network_sigma')
    ...
    def _generator_network(self):
        with tf.variable_scope('generator_network_layer_1'):
            ...
            gen_layer_1 = self.transfer_fct(tf.matmul(self.z, gen_weights_h1) + gen_biases_h1,
                                            name='generator_network_layer_1')
        ...
        with tf.variable_scope('generator_network_layer_2'):
            ...
            gen_layer_2 = self.transfer_fct(tf.matmul(gen_layer_1, gen_weights_h2) + gen_biases_h2,
                                            name='generator_network_layer_1')
        ...
        with tf.variable_scope('recognition_network_x'):
            ...
            x_reconstr_mean = tf.nn.sigmoid(tf.matmul(gen_layer_2, gen_weights_out) + gen_biases_out,
                                            name='recognition_network_x')
